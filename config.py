...
class Config:
    ...
    MOVIE_API_BASE_URL ='https://api.themoviedb.org/3/movie/{}?api_key=3dc732bc528e9816b9f31378696003fc'
    MOVIE_API_KEY = os.environ.get('3dc732bc528e9816b9f31378696003fc')
    SECRET_KEY = os.environ.get('54321')
